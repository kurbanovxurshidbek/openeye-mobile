...
public class KeyBoard extends InputMethodService implements KeyboardView.OnKeyboardActionListener{
  ...
  int[] index = {0,0,0,0,0,0};
    ...
    HashMap<String, HashMap<Lan, String>> multilingualMap = new HashMap<String, HashMap<Lan, String>>() {{
        ...
        put("010111", new HashMap<Lan, String>(){{ put(Lan.En, "w"); put(Lan.Uz, ""); put(Lan.Ru, "в"); }});
        ...
        put("100111", new HashMap<Lan, String>(){{ put(Lan.En, ""); put(Lan.Uz, ""); put(Lan.Ru, ""); }});
        ...
        put("101101", new HashMap<Lan, String>(){{ put(Lan.En, "x"); put(Lan.Uz, "x"); put(Lan.Ru, "щ"); }});
        put("101110", new HashMap<Lan, String>(){{ put(Lan.En, "n"); put(Lan.Uz, "n"); put(Lan.Ru, "н"); }});
        put("101111", new HashMap<Lan, String>(){{ put(Lan.En, "y"); put(Lan.Uz, "y"); put(Lan.Ru, ""); }});
        ...
        put("111001", new HashMap<Lan, String>(){{ put(Lan.En, "v"); put(Lan.Uz, "v"); put(Lan.Ru, ""); }});
        ...
        put("111101", new HashMap<Lan, String>(){{ put(Lan.En, ""); put(Lan.Uz, ""); put(Lan.Ru, "й"); }});
        put("111110", new HashMap<Lan, String>(){{ put(Lan.En, "q"); put(Lan.Uz, "q"); put(Lan.Ru, "ч"); }});
